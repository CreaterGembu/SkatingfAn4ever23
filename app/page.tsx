...
const SPINS: Element[] = [
  ...
  { name: '(F/C/FC)USp4', baseValue: 3.5, type: 'spin' },
  { name: '(F/C/FC)USp3', baseValue: 2.9, type: 'spin' },
  { name: '(F/C/FC)USp2', baseValue: 2.4, type: 'spin' },
  { name: '(F/C/FC)USp1', baseValue: 2.0, type: 'spin' },
  { name: '(F/C/FC)USpB', baseValue: 1.8, type: 'spin' },
  { name: '(F/C/FC)LSp4', baseValue: 3.8, type: 'spin' },
  { name: '(F/C/FC)LSp3', baseValue: 3.5, type: 'spin' },
  { name: '(F/C/FC)LSp2', baseValue: 2.9, type: 'spin' },
  { name: '(F/C/FC)LSp1', baseValue: 2.4, type: 'spin' },
  { name: '(F/C/FC)LSpB', baseValue: 2.0, type: 'spin' },
  { name: '(F/C/FC)CSp4', baseValue: 3.8, type: 'spin' },
  { name: '(F/C/FC)CSp3', baseValue: 3.4, type: 'spin' },
  { name: '(F/C/FC)CSp2', baseValue: 2.8, type: 'spin' },
  { name: '(F/C/FC)CSp1', baseValue: 2.4, type: 'spin' },
  { name: '(F/C/FC)CSpB', baseValue: 2.0, type: 'spin' },
  { name: '(F/C/FC)SSp4', baseValue: 3.6, type: 'spin' },
  { name: '(F/C/FC)SSp3', baseValue: 3.1, type: 'spin' },
  { name: '(F/C/FC)SSp2', baseValue: 2.8, type: 'spin' },
  { name: '(F/C/FC)SSp1', baseValue: 2.3, type: 'spin' },
  { name: '(F/C/FC)SSpB', baseValue: 1.9, type: 'spin' },
  { name: '(F)CoSp4', baseValue: 3.6, type: 'spin' },
  { name: '(F)CoSp3', baseValue: 3.0, type: 'spin' },
  { name: '(F)CoSp2', baseValue: 2.4, type: 'spin' },
  { name: '(F)CoSp1', baseValue: 2.0, type: 'spin' },
  { name: '(F)CoSpB', baseValue: 1.8, type: 'spin' },
  { name: '(FC/C)CoSp4', baseValue: 4.2, type: 'spin' },
  { name: '(FC/C)CoSp3', baseValue: 3.6, type: 'spin' },
  { name: '(FC/C)CoSp2', baseValue: 3.0, type: 'spin' },
  { name: '(FC/C)CoSp1', baseValue: 2.4, type: 'spin' },
  { name: '(FC/C)CoSpB', baseValue: 2.0, type: 'spin' },
];
